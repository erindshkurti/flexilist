...
import { Alert, Animated, FlatList, Image, Modal, Platform, Pressable, StyleSheet, Text, TextInput, TouchableOpacity, View } from 'react-native';
...
export default function HomeScreen() {
  ...
  return (
    <>
      ...
      {profileMenuVisible && (
        <View style={styles.profileMenu} pointerEvents="box-none">
          <View style={styles.profileMenuInner} pointerEvents="box-none">
            <View
